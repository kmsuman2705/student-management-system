...
$sql="insert into tblclass(SchemeName,TradeName)values(:scname,:trname)";
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="scname" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Trade Name</label>
                        <input type="text" name="trname" value="" class="form-control" required='true'>
