...
$sql="SELECT tblstudent.RegNo,tblstudent.ID as sid,tblstudent.StudentName,tblstudent.StudentEmail,tblstudent.DateofAdmission,tblclass.SchemeName,tblclass.TradeName from tblstudent join tblclass on tblclass.ID=tblstudent.StudentClass LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>   
                          <tr>
                            ...
                            <td><?php  echo htmlentities($row->SchemeName);?> <?php  echo htmlentities($row->TradeName);?></td>
