...
if (strlen($_SESSION['sturecmsaid']==0)) {
 ...
 $ret="select UserName from tblstudent where UserName=:uname || RegNo=:regno";
...
$sql="insert into tblstudent(StudentName,StudentEmail,StudentClass,Gender,DOB,RegNo,FatherName,MotherName,ContactNumber,AadharNumber,State,AcademicQlf,TechnicalQlf,UserName,Password,Image)values(:stuname,:stuemail,:stuclass,:gender,:dob,:regno,:fname,:mname,:connum,:aadharnum,:state,:acdqlf,:tecqlf,:uname,:password,:image)";
                    ...
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <select  name="stuclass" class="form-control" required='true'>
                          <option value="">Select Sheme</option>
                         <?php 
...
{          
    ?>  
<option value="<?php echo htmlentities($row1->ID);?>"><?php echo htmlentities($row1->SchemeName);?> <?php echo htmlentities($row1->TradeName);?></option>
 <?php } ?> 
                        </select>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="exampleInputName1">Registration No*</label>
                        <input type="text" name="regno" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="aadharnum" value="" class="form-control" required='true' maxlength="12" pattern="[0-9]+">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">State*</label>
                        <textarea name="state" class="form-control" required='true'></textarea>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Academic Qualification (Write None if you don't have)*</label>
                        <textarea name="acaqlf" class="form-control" required='true'></textarea>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Technical Qualification (Write None if you don't have)*</label>
                        <textarea name="tecqlf" class="form-control" required='true'></textarea>
                      </div>
<h3>Login details</h3>
<div class="form-group">
